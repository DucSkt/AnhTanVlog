...
class Forms extends Component {
  ...
  haha = (data) => {
    this.setState({ducskt: data.target.value })
    alert(this.state.ducskt);
  }
              ...
              <CardBody>
                  <Row>
                    <Col xs="12">
                      ...
                      <Input onChange={data => this.haha(data)} type="text" id="name" placeholder="Enter your name" required />
                    </FormGroup>
                  </Col>
                </Row>
                <Row>
